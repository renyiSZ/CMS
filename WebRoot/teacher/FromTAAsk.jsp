...
<html>
  <head>
    ...
    <title>My JSP 'fromTAAsk.jsp' starting page</title>
...
<input type="hidden" name="from" value="TA">
...
<table width="65%" border="1" bordercolor="grey">
	...
	/<i class="fa fa-question" aria-hidden="true"></i></font></div>
     <div  style="float:left;width:75%;">  &nbsp;&nbsp;<%=m.get("askcontent") %>
     </div></td>
     
     <td align="center"><a href="<%=path%>/TeacherAnswer?type=mark&from=TA&askid=<%=m.get("askid") %>"><button class="layui-btn layui-btn-radius">Mark as Read</button></a></td>
	</tr>
  ...
  <%
   ...
   %>
   <center>No TA feedback</center></br></br></br>
  <%
  }
   %>
