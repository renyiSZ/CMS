...
<html>
  <head>
    ...
    <title>My JSP 'fromStudentAsk.jsp' starting page</title>
...
<table width="65%" border="1" bordercolor="grey">
	...
	/<i class="fa fa-question" aria-hidden="true"></i></font></div>
     ...
     <td align="center"><a href="<%=path%>/TeacherAnswer?type=mark&from=student&askid=<%=m.get("askid") %>"><button class="layui-btn layui-btn-radius">Mark as Read</button></a></td>
	</tr>
  ...
  <%
   ...
   %>
   <center>No Advice or Questions from Students</center></br></br></br>
  <%
  }
   %>
