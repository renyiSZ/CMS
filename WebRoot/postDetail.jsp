...
<script type="text/javascript" src="assets/umeditor/lang/zh-cn/zh-cn.js"></script>
 ...
 <div class="wrapper row3">
  <div class="rnd">
    ...
    <button class="layui-btn layui-btn-small" onclick="javascript:window.location.href='<%=path%>/PageServlet?thispage=1&time=one&spitPageWhat=post';"> 
    ...
    <div class="messages">
		 <div class="messages_left">
			...
			<div class="headphoto"> <img src="${requestScope.map.posthead}" alt="${requestScope.map.userid}" /> </div>
		</div>
    ...
    <!-- ########################################################################################## -->
     ...
     <input name="flag" type="hidden"  value="detail">
     ...
     <input name="postreply" type="hidden" id="postreply" value="${requestScope.map.postreply}">
