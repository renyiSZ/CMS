...
<div style="height:600px; width: 80%; margin-left:10%;">	


		<!-- 聊天内容展示区域 -->
	<div id="ChatBox" class="am-g am-g-fixed" >
	
	  <div class="am-u-lg-12" style="float:left; margin-left:10%;height:300px;width: 60%;border:1px solid #999;overflow-y:scroll;">
	  ...
	  </div><div class="right" id="users" style="float:left;height: 300px; width:20%;margin-right:10%; padding:20px; border:1px solid grey;overflow-y:scroll;"></div>
	</div>
	
	<!-- 聊天内容发送区域 -->
	<div id="EditBox" class="am-g am-g-fixed" style="float:left;margin-left:10%;">
	<!--style给定宽度可以影响编辑器的最终宽度-->
	<script type="text/plain" id="myEditor" style="width:80%;height:70px;"></script>
	<button id="send" type="button" class="am-btn am-btn-primary am-btn-block" style="width:80%;">send</button>
	</div>
...
$(function(){
    ...
    var um = UM.getEditor('myEditor',{
    	...
    	toolbar:[
            ...
            'insertorderedlist | selectall cleardoc | fontfamily fontsize' ,
   ...
   var nickname="<%=session.getAttribute("uname")%>";
	...
	var socket = new WebSocket("ws://localhost:8080/finalProject2/tryweb/"+nickname);
	//10.213.14.103
    //接收服务器的消息
