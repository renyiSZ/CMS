...
<link rel="stylesheet" href="plugins/font-awesome/css/font-awesome.min.css">
  ...
  <%
     ...
     System.out.println("name:"+hwname);
  %>
			...
			xAxis : [ {
				...
				data :(function(){
                                    var arr=[];
                                        ...
                                        type : "post",
                                        async : false, //同步执行
                                         url : "HWAnalysisServlet?action=singlehw&hwid=<%=hwid%>",
                                        data : {},
    ...
    series : [
        {
            ...
            data :(function(){
                                    var res=[];
                                        ...
                                        type : "post",
                                        async : false, //同步执行
                                        url : "HWAnalysisServlet?action=singlehwpie&hwid=<%=hwid%>",
                                        data : {},
                                        dataType : "json", //返回数据形式为json
                                        success : function(result) {
                                        if (result) {
